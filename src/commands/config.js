 ...
 *
 * Only the `path` option (used by set) has autocomplete enabled; the `section`
 * option uses static choices. This handler suggests dot-notation leaf paths
 * that setConfigValue actually accepts (≥2 segments, leaf values only).
 *
